...
-- table received_files_fts_config
CREATE TABLE 'received_files_fts_config'(k PRIMARY KEY, v) WITHOUT ROWID;

-- table received_files_fts_data
CREATE TABLE 'received_files_fts_data'(id INTEGER PRIMARY KEY, block BLOB);

-- table received_files_fts_docsize
CREATE TABLE 'received_files_fts_docsize'(id INTEGER PRIMARY KEY, sz BLOB);

-- table received_files_fts_idx
CREATE TABLE 'received_files_fts_idx'(segid, term, pgno, PRIMARY KEY(segid, term)) WITHOUT ROWID;

-- table reverse_share_assets
...
-- index ix_rs_upload_sessions_expiry
